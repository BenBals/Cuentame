...
/***/ function(module, exports, __webpack_require__) {
	...
	var renderToPage = function renderToPage() {
	  // the render it self
	  var renderIt = function renderIt() {
	    _reactDom2.default.render(_react2.default.createElement(_App2.default, { state: store.getState() }), document.getElementById('mount'));
	  };
	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement('span', null, 'Hello');
	    }
	  }]);
